...
define([
    ...
    var SMUtils = {
        ...
        getQueryString4ServersUrl : function(hashParams) {
        ...
        handleChassisId : function (params) {
        ...
        renderView : function (renderConfig, renderCallback) {
